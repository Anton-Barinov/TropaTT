...
final class SchemaManager
{
    ...
    public function createSchema(PDO $pdo, string $driver): void
    {
        ...
        $tables = [
            ...
            "CREATE TABLE IF NOT EXISTS users (id {$id}, public_id VARCHAR(64) UNIQUE, login VARCHAR(120) UNIQUE, email VARCHAR(190), password_hash VARCHAR(255), auth_token_hash VARCHAR(255), full_name VARCHAR(255), locale VARCHAR(16), is_active {$bool} DEFAULT 1, is_root {$bool} DEFAULT 0, is_external {$bool} DEFAULT 0, external_role VARCHAR(20) NOT NULL DEFAULT 'observer', created_by_user_id INTEGER NULL, created_at {$dt}, updated_at {$dt}, deleted_at {$dt} NULL, cost_rate DECIMAL(12,2) DEFAULT NULL, bill_rate DECIMAL(12,2) DEFAULT NULL, payout_rate DECIMAL(12,2) DEFAULT NULL)",
            ...
            "CREATE TABLE IF NOT EXISTS api_keys (id {$id}, public_id VARCHAR(64) UNIQUE, client_id INTEGER, user_id INTEGER NULL, name VARCHAR(255) NULL, key_hash VARCHAR(255), key_preview VARCHAR(64) NULL, scopes {$text}, expires_at {$dt} NULL, revoked_at {$dt} NULL, created_at {$dt})",
            ...
            "CREATE TABLE IF NOT EXISTS files (id {$id}, public_id VARCHAR(64) UNIQUE, entity_type VARCHAR(32), entity_public_id VARCHAR(64), uploader_user_id INTEGER, original_name VARCHAR(255), storage_path {$text}, mime_type VARCHAR(128), size_bytes BIGINT, is_deleted {$bool} DEFAULT 0, is_internal {$bool} DEFAULT 0, created_at {$dt}, deleted_at {$dt} NULL)",
            "CREATE TABLE IF NOT EXISTS statuses (id {$id}, public_id VARCHAR(64) UNIQUE, scope VARCHAR(64), code VARCHAR(64), title VARCHAR(255), color VARCHAR(32), sort_order INTEGER, is_active {$bool} DEFAULT 1, is_closed {$bool} DEFAULT 0, created_at {$dt}, updated_at {$dt})",
            ...
            "CREATE TABLE IF NOT EXISTS chat_participants (id {$id}, chat_id INTEGER NOT NULL, user_id INTEGER NOT NULL, role VARCHAR(32) DEFAULT 'member', is_favorite {$bool} DEFAULT 0, muted_until {$dt} NULL, joined_at {$dt} NULL, CONSTRAINT uq_chat_participant UNIQUE (chat_id, user_id))",
            ...
            "CREATE TABLE IF NOT EXISTS chat_read_markers (id {$id}, chat_id INTEGER NOT NULL, user_id INTEGER NOT NULL, last_read_message_id INTEGER DEFAULT 0, updated_at {$dt} NULL, CONSTRAINT uq_chat_read UNIQUE (chat_id, user_id))",
            ...
            "CREATE TABLE IF NOT EXISTS calendar_events (id {$id}, public_id VARCHAR(64) UNIQUE, title VARCHAR(255), description {$text} NULL, starts_at {$dt}, ends_at {$dt}, owner_user_id INTEGER, project_id INTEGER NULL, task_id INTEGER NULL, source_type VARCHAR(64) NULL, source_owner_user_id INTEGER NULL, source_external_id VARCHAR(255) NULL, created_at {$dt}, updated_at {$dt})",
            "CREATE TABLE IF NOT EXISTS work_logs (id {$id}, public_id VARCHAR(64) UNIQUE, user_id INTEGER, task_id INTEGER, minutes_spent INTEGER, note {$text}, logged_at {$dt}, started_at {$dt} NULL, ended_at {$dt} NULL, activity_code VARCHAR(64) NULL, cost_rate_snapshot DECIMAL(12,2) NULL, bill_rate_snapshot DECIMAL(12,2) NULL, payout_rate_snapshot DECIMAL(12,2) NULL, currency_code VARCHAR(8) NULL, cost_source_type VARCHAR(32) NULL, cost_source_ref VARCHAR(64) NULL, bill_source_type VARCHAR(32) NULL, bill_source_ref VARCHAR(64) NULL, payout_source_type VARCHAR(32) NULL, payout_source_ref VARCHAR(64) NULL, rate_resolved_at {$dt} NULL, rate_ambiguous {$bool} DEFAULT 0, rate_locked_at {$dt} NULL, client_public_id VARCHAR(64) NULL, project_public_id VARCHAR(64) NULL, created_at {$dt})",
            ...
            "CREATE TABLE IF NOT EXISTS recurring_rules (id {$id}, public_id VARCHAR(64) UNIQUE, title VARCHAR(255) NULL, entity_type VARCHAR(64), entity_public_id VARCHAR(64), rrule {$text}, is_active {$bool} DEFAULT 1, last_processed_at {$dt} NULL, generated_count INTEGER DEFAULT 0, created_at {$dt}, updated_at {$dt})",
            ...
            "CREATE TABLE IF NOT EXISTS two_factor_secrets (id {$id}, public_id VARCHAR(64) UNIQUE, user_id INTEGER, secret_hash VARCHAR(255), backup_codes {$text}, last_totp_step BIGINT DEFAULT 0, last_login_nonce_hash VARCHAR(128) NULL, created_at {$dt}, updated_at {$dt})",
            ...
            "CREATE TABLE IF NOT EXISTS rate_cards (id {$id}, public_id VARCHAR(64) UNIQUE, organization_id INTEGER NULL, title VARCHAR(255) NOT NULL, description {$text} NULL, currency_code VARCHAR(8) NULL, is_default {$bool} DEFAULT 0, is_archived {$bool} DEFAULT 0, created_by_user_id INTEGER NULL, created_at {$dt} NOT NULL, updated_at {$dt} NOT NULL, deleted_at {$dt} NULL, row_version INTEGER NOT NULL DEFAULT 1)",
            "CREATE TABLE IF NOT EXISTS rate_card_lines (id {$id}, public_id VARCHAR(64) UNIQUE, organization_id INTEGER NULL, rate_card_id INTEGER NOT NULL, user_id INTEGER NULL, role_code VARCHAR(64) NULL, activity_code VARCHAR(64) NULL, cost_rate DECIMAL(12,2) NULL, bill_rate DECIMAL(12,2) NULL, payout_rate DECIMAL(12,2) NULL, currency_code VARCHAR(8) NULL, effective_from DATE NOT NULL, effective_to DATE NULL, note VARCHAR(500) NULL, created_at {$dt} NOT NULL, updated_at {$dt} NOT NULL, deleted_at {$dt} NULL, row_version INTEGER NOT NULL DEFAULT 1)",
            "CREATE TABLE IF NOT EXISTS rate_card_assignments (id {$id}, public_id VARCHAR(64) UNIQUE, organization_id INTEGER NULL, rate_card_id INTEGER NOT NULL, scope_type VARCHAR(32) NOT NULL, scope_ref VARCHAR(64) NOT NULL, priority INTEGER NOT NULL DEFAULT 100, effective_from DATE NOT NULL, effective_to DATE NULL, created_by_user_id INTEGER NULL, created_at {$dt} NOT NULL, updated_at {$dt} NOT NULL, deleted_at {$dt} NULL)",
        ];
