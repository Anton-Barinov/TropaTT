...
final class SchemaManager
{
    ...
    public function createSchema(PDO $pdo, string $driver): void
    {
        ...
        $tables = [
            ...
            "CREATE TABLE IF NOT EXISTS api_keys (id {$id}, public_id VARCHAR(64) UNIQUE, client_id INTEGER, user_id INTEGER NULL, name VARCHAR(255) NULL, key_hash VARCHAR(255), scopes {$text}, expires_at {$dt} NULL, revoked_at {$dt} NULL, created_at {$dt})",
