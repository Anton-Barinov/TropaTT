...
final class SchemaManager
{
    ...
    public function createSchema(PDO $pdo, string $driver): void
    {
        ...
        $tables = [
            ...
            "CREATE TABLE IF NOT EXISTS rate_cards (id {$id}, public_id VARCHAR(64) UNIQUE, title VARCHAR(255) NOT NULL, description {$text} NULL, currency_code VARCHAR(8) NULL, is_default {$bool} DEFAULT 0, is_archived {$bool} DEFAULT 0, created_by_user_id INTEGER NULL, created_at {$dt} NOT NULL, updated_at {$dt} NOT NULL, deleted_at {$dt} NULL, row_version INTEGER NOT NULL DEFAULT 1)",
            "CREATE TABLE IF NOT EXISTS rate_card_lines (id {$id}, public_id VARCHAR(64) UNIQUE, rate_card_id INTEGER NOT NULL, user_id INTEGER NULL, role_code VARCHAR(64) NULL, activity_code VARCHAR(64) NULL, cost_rate DECIMAL(12,2) NULL, bill_rate DECIMAL(12,2) NULL, payout_rate DECIMAL(12,2) NULL, currency_code VARCHAR(8) NULL, effective_from DATE NOT NULL, effective_to DATE NULL, note VARCHAR(500) NULL, created_at {$dt} NOT NULL, updated_at {$dt} NOT NULL, deleted_at {$dt} NULL, row_version INTEGER NOT NULL DEFAULT 1)",
            "CREATE TABLE IF NOT EXISTS rate_card_assignments (id {$id}, public_id VARCHAR(64) UNIQUE, rate_card_id INTEGER NOT NULL, scope_type VARCHAR(32) NOT NULL, scope_ref VARCHAR(64) NOT NULL, priority INTEGER NOT NULL DEFAULT 100, effective_from DATE NOT NULL, effective_to DATE NULL, created_by_user_id INTEGER NULL, created_at {$dt} NOT NULL, updated_at {$dt} NOT NULL, deleted_at {$dt} NULL)",
        ];
