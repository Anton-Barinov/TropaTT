...
/** Adds the workspace boundary to the knowledge root tables. */
final class OrganizationKnowledgeScopeMigration implements MigrationInterface
{
    /** @var list<string> */
    private const TABLES = ['knowledge_spaces', 'knowledge_pages'];

    public function key(): string
    {
        return '20260919_000004_organization_knowledge_scope';
    }

    public function description(): string
    {
        return 'Scope knowledge spaces and pages by workspace';
    }
    ...
    public function up(PDO $pdo, string $driver): void
    {
        ...
        if ($default === false || $default === null) {
            throw new \RuntimeException('Unable to resolve default workspace for knowledge scope migration');
        }
