    ...
    public function list(array $filters, ?int $actorUserId = null, bool $actorIsRoot = false, bool $rlsScoped = false): array
    {
        ...
        $builder = $this->buildListQuery($filters, $actorUserId, $actorIsRoot, $order, $rlsScoped)
            ...
            ->select([
                ...
                "(SELECT CONCAT('[', GROUP_CONCAT(JSON_OBJECT('public_id', tg.public_id, 'code', tg.code, 'title', tg.title, 'color', tg.color)), ']')
                  FROM entity_tags et
                ...
                "(SELECT CONCAT('[', GROUP_CONCAT(JSON_OBJECT('public_id', pm.public_id, 'title', pm.title, 'status', pm.status)), ']')
