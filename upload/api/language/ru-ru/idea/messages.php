...
return [
    ...
    'ai_feature_disabled' => 'AI-функции идей отключены в этой установке.',
    ...
    'analysis_queued' => 'Анализ поставлен в очередь',

    'no_pending_steps' => 'Нет ожидающих шагов',
    'awaiting_human_input' => 'Ожидает ответов пользователя',
    'step_busy' => 'Шаг уже выполняется другим обработчиком',
...
{"summary":"Обзор проекта","projects":[{"id":"p1","title":"Название проекта","description":"Описание","tasks":[{"id":"t1","title":"Задача","description":"Описание без фигурных скобок","priority":"high","estimated_time":"2-3 часа","expected_outcome":"Результат","subtasks":[{"id":"t1.1","title":"Подзадача","description":"Описание","priority":"high","estimated_time":"1 час","expected_outcome":"Результат"}]}]}]}',
    ...
    'create_failed' => 'Ошибка создания. Проверьте логи сервера.',
    'ai_operation_failed' => 'Ошибка AI-операции. Проверьте логи сервера.',
    'max_cycles_reached' => 'Достигнут максимальный лимит циклов вопросов (25)',
];
