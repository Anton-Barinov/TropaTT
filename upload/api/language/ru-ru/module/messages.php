...
return [
    ...
    'signing_key_missing' => 'Установка недоступна: в .env не задан MODULE_SIGNING_KEY (ключ подписи пакетов). Установка из официального маркетплейса ключа не требует — он нужен для прямых URL и загруженных ZIP-файлов',
    'marketplace_sha256_mismatch' => 'Скачанный пакет не совпал с контрольной суммой (sha256) релиза маркетплейса — файл повреждён или отдан не тот архив. Повторите попытку',
];