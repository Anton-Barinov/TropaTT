...
final class DashboardController extends BaseController
{
    ...
    private const WIDGET_DEFINITIONS = [
        ...
        'my_workload_efficiency' => ['label_key' => 'dashboard.extra_my_workload_efficiency', 'label' => 'My load and efficiency', 'description_key' => 'dashboard.extra_my_workload_efficiency_desc', 'description' => 'Personal load, logged hours, completion speed and efficiency signals.', 'size' => 'crm-col-6', 'icon' => 'fa-gauge-high', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'tasks_actual_time' => ['label_key' => 'dashboard.extra_tasks_actual_time', 'label' => 'Task actual time', 'description_key' => 'dashboard.extra_tasks_actual_time_desc', 'description' => 'Top tasks by logged time with median, coverage and activity split.', 'size' => 'crm-col-6', 'icon' => 'fa-stopwatch', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'my_kpi_scorecard' => ['label_key' => 'dashboard.extra_my_kpi_scorecard', 'label' => 'My KPI scorecard', 'description_key' => 'dashboard.extra_my_kpi_scorecard_desc', 'description' => 'Personal KPIs with period-over-period deltas, stale work and logging streak.', 'size' => 'crm-col-6', 'icon' => 'fa-clipboard-check', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'assignee_department_load' => ['label_key' => 'dashboard.extra_assignee_department_load', 'label' => 'Assignee and department load', 'description_key' => 'dashboard.extra_assignee_department_load_desc', 'description' => 'Active, overdue and weekly hours per assignee, aggregated by department.', 'size' => 'crm-col-12', 'icon' => 'fa-people-group', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'tasks_completion_velocity' => ['label_key' => 'dashboard.extra_tasks_completion_velocity', 'label' => 'Completion velocity', 'description_key' => 'dashboard.extra_tasks_completion_velocity_desc', 'description' => 'Weekly throughput, WIP and cycle time (median and 90th percentile).', 'size' => 'crm-col-6', 'icon' => 'fa-gauge-simple-high', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'workload_efficiency_management' => ['label_key' => 'dashboard.extra_workload_efficiency_management', 'label' => 'Workload and efficiency management', 'description_key' => 'dashboard.extra_workload_efficiency_management_desc', 'description' => 'Load, efficiency and risk signals for the people you manage.', 'size' => 'crm-col-12', 'icon' => 'fa-sliders', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'streams_load_efficiency' => ['label_key' => 'dashboard.extra_streams_load_efficiency', 'label' => 'Streams (projects) load and efficiency', 'description_key' => 'dashboard.extra_streams_load_efficiency_desc', 'description' => 'Progress, overdue work, hours and health for every accessible project.', 'size' => 'crm-col-12', 'icon' => 'fa-diagram-project', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'stream_detail_load_efficiency' => ['label_key' => 'dashboard.extra_stream_detail_load_efficiency', 'label' => 'Stream detail', 'description_key' => 'dashboard.extra_stream_detail_load_efficiency_desc', 'description' => 'One project in depth: progress, throughput, cycle time, members and milestones.', 'size' => 'crm-col-12', 'icon' => 'fa-chart-simple', 'default_enabled' => false, 'permissions' => ['task.manage']],
        'system_health' => ['label_key' => 'dashboard.extra_system_health', 'label' => 'System health', 'description_key' => 'dashboard.extra_system_health_desc', 'description' => 'A lightweight health signal for the current installation.', 'size' => 'crm-col-4', 'icon' => 'fa-heart-pulse', 'default_enabled' => false, 'permissions' => ['settings.manage']],
        'active_sessions' => ['label_key' => 'dashboard.extra_active_sessions', 'label' => 'Active sessions', 'description_key' => 'dashboard.extra_active_sessions_desc', 'description' => 'Your currently active sessions and devices.', 'size' => 'crm-col-4', 'icon' => 'fa-shield-halved', 'default_enabled' => false, 'permissions' => []],
    ];
