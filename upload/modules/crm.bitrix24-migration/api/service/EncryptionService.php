...
final class EncryptionService
{
    private static function key(): string
    {
        ...
        if ($secret === '') throw new RuntimeException('APP_SECRET is not configured for Bitrix24 credential encryption');
        return hash_hkdf('sha256', $secret, 32, 'bitrix24-migration');
    }
    ...
    public static function encrypt(string $plaintext): string
    {
        ...
        if (!is_string($ciphertext) || $ciphertext === '') throw new RuntimeException('BITRIX24_CREDENTIAL_ENCRYPT_FAILED');
