...
<div class="mt-3 pt-3 border-top" id="contactKnowledgeSection">
  ...
  <div class="mt-3 pt-3 border-top"><h6 class="mb-2 d-flex align-items-center gap-2" data-i18n="contacts.team_knowledge_title"><span class="crm-icon text-muted" aria-hidden="true"><i class="fa-solid fa-users" aria-hidden="true"></i></span><?= htmlspecialchars($t('contacts.team_knowledge_title', 'Материалы команды'), ENT_QUOTES, 'UTF-8') ?></h6><div id="contactTeamKnowledgeList"><div class="text-muted small">—</div></div></div>
...
(function () {
  ...
  editModal.addEventListener('show.bs.modal', function () {
    ...
    (async function () {
      ...
      if (teamKnowledgeList && window.CRM && window.CRM.teamMaterials) {
        window.CRM.teamMaterials.render({
          container: teamKnowledgeList,
          entityType: 'contact',
          entityPublicId: contactId,
          api: api,
          texts: {
            ...
            empty: <?= json_encode($t('contacts.team_knowledge_empty', 'Нет материалов команды'), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP) ?>,
