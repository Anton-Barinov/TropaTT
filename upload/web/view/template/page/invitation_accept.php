  ...
  <section class="crm-login-panel">
    ...
    <form id="invitationAcceptForm" class="crm-card">
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="password" name="password" placeholder="<?= htmlspecialchars($t('invitation_accept.placeholder_password', 'Минимум 6 символов: заглавная и строчная буквы, цифра'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-placeholder="invitation_accept.placeholder_password" value="">
        <div class="form-text" data-i18n="invitation_accept.password_hint"><?= htmlspecialchars($t('invitation_accept.password_hint', 'Пароль должен содержать не менее 6 символов, включая заглавные и строчные буквы и цифры.'), ENT_QUOTES, 'UTF-8') ?></div>
      </div>
