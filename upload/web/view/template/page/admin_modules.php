...
<div class="crm-bulk-actions d-none align-items-center flex-wrap gap-2 p-2 border-bottom" id="moduleBulkToolbar">
    ...
    <button type="button" class="btn btn-sm crm-btn-primary" id="bulkInstallBtn" data-i18n="admin_modules.bulk_install"><i class="fa-solid fa-download"></i> <?= htmlspecialchars($t('admin_modules.bulk_install', 'Установить'), ENT_QUOTES, 'UTF-8') ?></button>
    <button type="button" class="btn btn-sm crm-btn-success" id="bulkActivateBtn" data-i18n="admin_modules.bulk_activate"><i class="fa-solid fa-play"></i> <?= htmlspecialchars($t('admin_modules.bulk_activate', 'Активировать'), ENT_QUOTES, 'UTF-8') ?></button>
    <button type="button" class="btn btn-sm crm-btn-warning" id="bulkDeactivateBtn" data-i18n="admin_modules.bulk_deactivate"><i class="fa-solid fa-pause"></i> <?= htmlspecialchars($t('admin_modules.bulk_deactivate', 'Деактивировать'), ENT_QUOTES, 'UTF-8') ?></button>
    <button type="button" class="btn btn-sm crm-btn-danger" id="bulkUninstallBtn" data-i18n="admin_modules.bulk_uninstall"><i class="fa-solid fa-trash"></i> <?= htmlspecialchars($t('admin_modules.bulk_uninstall', 'Удалить'), ENT_QUOTES, 'UTF-8') ?></button>
    <button type="button" class="btn btn-sm crm-btn-danger" id="bulkPurgeBtn" data-i18n="admin_modules.bulk_purge"><i class="fa-solid fa-eraser"></i> <?= htmlspecialchars($t('admin_modules.bulk_purge', 'Удалить полностью'), ENT_QUOTES, 'UTF-8') ?></button>
    <button type="button" class="btn btn-sm crm-btn-secondary" id="bulkClearBtn" data-i18n="admin_modules.bulk_clear"><i class="fa-solid fa-xmark"></i> <?= htmlspecialchars($t('admin_modules.bulk_clear', 'Снять выбор'), ENT_QUOTES, 'UTF-8') ?></button>
</div>
