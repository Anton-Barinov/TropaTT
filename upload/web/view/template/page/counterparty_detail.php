...
<div class="row g-3">
  ...
  <div class="col-lg-4">
    ...
    <div class="crm-card crm-section-card mt-3">
      <div class="crm-section-head"><div><h2 class="h6 mb-0" data-i18n="counterparty_detail.section_requisites"><?= htmlspecialchars($t('counterparty_detail.section_requisites', 'Реквизиты'), ENT_QUOTES, 'UTF-8') ?></h2><div class="crm-section-note" data-i18n="counterparty_detail.section_requisites_note"><?= htmlspecialchars($t('counterparty_detail.section_requisites_note', 'Юридические и банковские данные.'), ENT_QUOTES, 'UTF-8') ?></div></div><button class="btn btn-sm crm-inline-icon-btn" id="counterpartyRequisitesEditBtn" type="button" aria-label="<?= htmlspecialchars($t('counterparty_detail.btn_edit_requisites_aria', 'Редактировать реквизиты'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-aria-label="counterparty_detail.btn_edit_requisites_aria"><span class="crm-icon" aria-hidden="true"><i class="fa-solid fa-pen"></i></span></button></div>
