...
<div class="crm-pr-tabs" role="tablist" aria-label="<?= htmlspecialchars($t('counterparty_detail.tabs_label', 'Разделы контрагента'), ENT_QUOTES, 'UTF-8') ?>">
  <button class="crm-pr-tab active" type="button" role="tab" aria-selected="true" data-cp-tab="overview" id="counterpartyTabOverview" data-i18n="counterparty_detail.tab_overview"><?= htmlspecialchars($t('counterparty_detail.tab_overview', 'Обзор'), ENT_QUOTES, 'UTF-8') ?></button>
  <button class="crm-pr-tab" type="button" role="tab" aria-selected="false" data-cp-tab="contacts" id="counterpartyTabContacts" data-i18n="counterparty_detail.section_contacts"><?= htmlspecialchars($t('counterparty_detail.section_contacts', 'Контакты'), ENT_QUOTES, 'UTF-8') ?><span class="crm-pr-tab-count" id="counterpartyContactsTabCount">0</span></button>
  <button class="crm-pr-tab" type="button" role="tab" aria-selected="false" data-cp-tab="tasks" id="counterpartyTabTasks" data-i18n="counterparty_detail.section_tasks"><?= htmlspecialchars($t('counterparty_detail.section_tasks', 'Связанные задачи'), ENT_QUOTES, 'UTF-8') ?><span class="crm-pr-tab-count" id="counterpartyTasksTabCount">0</span></button>
  <button class="crm-pr-tab" type="button" role="tab" aria-selected="false" data-cp-tab="knowledge" id="counterpartyTabKnowledge" data-i18n="counterparty_detail.section_knowledge"><?= htmlspecialchars($t('counterparty_detail.section_knowledge', 'База знаний'), ENT_QUOTES, 'UTF-8') ?></button>
</div>
