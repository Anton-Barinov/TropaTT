...
/** @var callable(string, string): string $t */
?>
...
<div class="modal fade" id="createWebhookModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable"><div class="modal-content">
    ...
    <form id="createWebhookForm"><div class="modal-body">
      <div class="mb-3"><label class="form-label" for="webhookTitle" data-i18n="admin_webhooks.field_title"><?= htmlspecialchars($t('admin_webhooks.field_title', 'Название'), ENT_QUOTES, 'UTF-8') ?></label><input class="form-control" id="webhookTitle" name="title" required type="text" placeholder="<?= htmlspecialchars($t('admin_webhooks.placeholder_title', 'Например: Уведомления в Slack'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-placeholder="admin_webhooks.placeholder_title"></div>
      <div class="mb-3"><label class="form-label" for="webhookUrl" data-i18n="admin_webhooks.field_url"><?= htmlspecialchars($t('admin_webhooks.field_url', 'URL'), ENT_QUOTES, 'UTF-8') ?></label><input class="form-control" id="webhookUrl" name="endpoint" required type="url" placeholder="<?= htmlspecialchars($t('admin_webhooks.placeholder_url', 'https://example.com/webhook'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-placeholder="admin_webhooks.placeholder_url"></div>
