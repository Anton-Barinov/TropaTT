...
var visibilityBadge=i.visibility==='private'?' <span class="badge bg-warning text-dark" style="font-size:0.65rem"><?= htmlspecialchars($t('ideas.badge_private', 'приватная'), ENT_QUOTES, 'UTF-8') ?></span>':'';
  ...
  var delBtn='<button class="btn btn-sm crm-btn-danger idea-del-btn" data-pid="'+i.public_id+'" title="<?= htmlspecialchars($t('ideas.btn_delete', 'Удалить'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-title="ideas.btn_delete"><i class="fa-solid fa-trash-can" aria-hidden="true"></i></button>';
