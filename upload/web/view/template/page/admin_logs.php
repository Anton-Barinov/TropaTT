...
<ul class="nav nav-pills crm-log-tabs mb-3 flex-nowrap overflow-auto" id="adminLogsTabs" role="tablist">
  <li class="nav-item" role="presentation"><button class="nav-link active" type="button" role="tab" data-log-tab="errors"><i class="fa-solid fa-bug me-1"></i><span data-i18n="admin_logs.tab_errors"><?= htmlspecialchars($t('admin_logs.tab_errors', 'Ошибки'), ENT_QUOTES, 'UTF-8') ?></span></button></li>
  <li class="nav-item" role="presentation"><button class="nav-link" type="button" role="tab" data-log-tab="users"><i class="fa-solid fa-user-clock me-1"></i><span data-i18n="admin_logs.tab_users"><?= htmlspecialchars($t('admin_logs.tab_users', 'Действия'), ENT_QUOTES, 'UTF-8') ?></span></button></li>
  <li class="nav-item" role="presentation"><button class="nav-link" type="button" role="tab" data-log-tab="api"><i class="fa-solid fa-plug me-1"></i><span data-i18n="admin_logs.tab_api"><?= htmlspecialchars($t('admin_logs.tab_api', 'API-запросы'), ENT_QUOTES, 'UTF-8') ?></span></button></li>
  <li class="nav-item" role="presentation"><button class="nav-link" type="button" role="tab" data-log-tab="security"><i class="fa-solid fa-shield-halved me-1"></i><span data-i18n="admin_logs.tab_security"><?= htmlspecialchars($t('admin_logs.tab_security', 'Вход и безопасность'), ENT_QUOTES, 'UTF-8') ?></span></button></li>
  <li class="nav-item" role="presentation"><button class="nav-link" type="button" role="tab" data-log-tab="mcp"><i class="fa-solid fa-robot me-1"></i><span data-i18n="admin_logs.tab_mcp"><?= htmlspecialchars($t('admin_logs.tab_mcp', 'MCP / AI'), ENT_QUOTES, 'UTF-8') ?></span></button></li>
  <li class="nav-item" role="presentation"><button class="nav-link" type="button" role="tab" data-log-tab="worklog"><i class="fa-solid fa-stopwatch me-1"></i><span data-i18n="admin_logs.tab_worklog"><?= htmlspecialchars($t('admin_logs.tab_worklog', 'Учёт времени'), ENT_QUOTES, 'UTF-8') ?></span></button></li>
</ul>
