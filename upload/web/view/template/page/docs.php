...
<ul>
<li data-i18n="docs.mcp_item1"><?= $t('docs.mcp_item1', '<strong>615 MCP-инструментов + 6 ресурсов</strong> — задачи, проекты, клиенты, контакты, чаты, календарь, аналитика, база знаний.') ?></li>
...
<tr><td>MCP</td><td>615 инструментов + 6 ресурсов</td></tr>
