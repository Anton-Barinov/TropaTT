...
<section class="crm-intake-filters crm-filters-card">
  <div class="crm-intake-search">
    ...
    <div class="crm-intake-search-control">
      ...
      <button class="btn crm-btn-ghost crm-btn-icon d-none" type="button" id="intakeSearchClearBtn" aria-label="<?= htmlspecialchars($t('intake.filter_search_clear', 'Очистить поиск'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-aria-label="intake.filter_search_clear"><i class="fa-solid fa-xmark"></i></button>
    </div>
  </div>
  <div>
  ...
  <div class="crm-intake-filter-summary">
    ...
    <div class="crm-intake-filter-actions">
      <button class="btn crm-btn-secondary" type="button" id="intakeRefreshBtn" data-i18n="intake.refresh"><i class="fa-solid fa-rotate me-1"></i><?= htmlspecialchars($t('intake.refresh', 'Обновить'), ENT_QUOTES, 'UTF-8') ?></button>
