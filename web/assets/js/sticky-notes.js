  ...
  function renderNotes() {
    ...
    list.innerHTML = items.map(function (note) {
      ...
      return '<div class="col-12 col-sm-6 col-md-4 col-lg-3" data-note-id="' + esc(note.public_id) + '">'
        ...
        + (isEditing
          ? '<textarea class="form-control form-control-sm crm-sticky-edit-textarea" data-note-id="' + esc(note.public_id) + '" rows="3" style="background:transparent;border:1px dashed #666;width:100%;resize:vertical;font-size:13px">' + esc(note.content) + '</textarea>'
