...
<body data-page="admin-templates" data-protected="1"><div class="crm-app"><aside class="crm-sidebar"><div class="crm-brand"><span class="crm-brand-mark"></span> <?= htmlspecialchars($t('app.name', 'TropaTT'), ENT_QUOTES, 'UTF-8') ?></div><nav class="nav flex-column crm-nav"></nav></aside>
...
<div class="modal fade" id="createTaskTemplateModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog"><div class="modal-content">
    ...
    <form id="createTaskTemplateForm"><div class="modal-body">
      ...
      <div class="mb-3"><label class="form-label" for="taskTemplateDescription" data-i18n="admin_templates.field_description"><?= htmlspecialchars($t('admin_templates.field_description', 'Описание'), ENT_QUOTES, 'UTF-8') ?></label><textarea class="form-control" id="taskTemplateDescription" name="description" rows="3" data-crm-visual-editor="1" data-richtext-off="1"></textarea></div>
...
<div class="modal fade" id="createProjectTemplateModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog"><div class="modal-content">
    ...
    <form id="createProjectTemplateForm"><div class="modal-body">
      ...
      <div class="mb-3"><label class="form-label" for="projectTemplateDescription" data-i18n="admin_templates.field_description"><?= htmlspecialchars($t('admin_templates.field_description', 'Описание'), ENT_QUOTES, 'UTF-8') ?></label><textarea class="form-control" id="projectTemplateDescription" name="description" rows="3" data-crm-visual-editor="1" data-richtext-off="1"></textarea></div>
    </div><div class="modal-footer"><button type="button" class="btn crm-btn-secondary" data-bs-dismiss="modal" data-i18n="page.cancel"><?= htmlspecialchars($t('page.cancel', 'Отмена'), ENT_QUOTES, 'UTF-8') ?></button><button type="submit" class="btn crm-btn-primary" data-i18n="page.create"><?= htmlspecialchars($t('page.create', 'Создать'), ENT_QUOTES, 'UTF-8') ?></button></div></form>
  </div></div>
</div>
