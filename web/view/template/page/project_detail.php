...
<div class="row g-3">
  <div class="col-lg-8">
    ...
    <section class="crm-card mb-3" id="projectModulesSection">
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h2 class="h6 mb-0" data-i18n="project_detail.section_modules"><?= htmlspecialchars($t('project_detail.section_modules', 'Модули проекта'), ENT_QUOTES, 'UTF-8') ?></h2>
        <button class="btn btn-sm crm-btn-primary crm-btn-compact" type="button" id="projectModuleAddBtn" data-i18n="project_detail.btn_add_module"><?= htmlspecialchars($t('project_detail.btn_add_module', '+ Модуль'), ENT_QUOTES, 'UTF-8') ?></button>
      </div>
