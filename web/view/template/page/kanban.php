...
<section class="crm-kanban-filters crm-filters-card kanban-filter" aria-label="<?= htmlspecialchars($t('kanban.filters_aria', 'Фильтры канбан-доски'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-aria-label="kanban.filters_aria">
...
<div style="display:none" id="kanbanTagChipFilter"></div>
