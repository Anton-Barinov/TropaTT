...
<section class="crm-kanban-filters" aria-label="<?= htmlspecialchars($t('kanban.filters_aria', 'Фильтры канбан-доски'), ENT_QUOTES, 'UTF-8') ?>" data-i18n-aria-label="kanban.filters_aria">
  ...
  <div>
    <label class="crm-filter-label" for="kanbanTagFilter">Тег</label>
    <select class="form-select" id="kanbanTagFilter" aria-label="Фильтр по тегам"></select>
  </div>
