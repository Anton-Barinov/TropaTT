...
<main class="crm-content crm-analytics-page"><div class="crm-page-head"><div><h1 class="crm-page-title">Аналитика</h1><p class="crm-subtitle" data-analytics-subtitle>SLA, выполнение задач, загрузка команд и проектные риски.</p></div><div class="crm-page-actions"><button class="btn crm-btn-secondary" type="button" id="analyticsExportBtn" disabled>Экспорт CSV</button></div></div>
