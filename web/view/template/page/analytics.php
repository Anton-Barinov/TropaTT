...
<div class="crm-toolbar-surface crm-analytics-toolbar mb-3" aria-label="Фильтры аналитики"><div><label class="crm-filter-label" for="analyticsProjectFilter">Проект</label><select class="form-select crm-field-w-220" id="analyticsProjectFilter" aria-label="Проект"><option value="">Все проекты</option></select></div><div><label class="crm-filter-label" for="analyticsTeamFilter">Исполнитель</label><select class="form-select crm-field-w-220" id="analyticsTeamFilter" aria-label="Исполнитель"><option value="">Все исполнители</option></select></div><button class="btn crm-btn-secondary" type="button" id="analyticsApplyBtn">Применить</button><span class="crm-toolbar-note" data-analytics-filter-note>Показан общий срез по доступным данным.</span></div>
  ...
  <div class="col-12">
    <div class="crm-card crm-section-card" id="analyticsAiCard" data-ai-state="idle">
      ...
      <div class="crm-analytics-ai-pills mb-2">
        ...
        <button class="btn btn-sm btn-light" type="button" id="analyticsAiPreviewBtn" disabled title="Открыть предпросмотр AI-предложения">Предпросмотр</button>
