        ...
        <div class="modal-content">
          ...
          <form id="approvalsCreateForm">
            <div class="modal-body">
              ...
              <div class="mt-3"><label class="form-label">Согласующие</label><select id="approvalsReviewersSelect" class="form-select" name="reviewer_public_ids" multiple></select><div class="crm-inline-help mt-2"><i class="fa-solid fa-users" aria-hidden="true"></i><span>Выберите одного или нескольких пользователей. Можно удерживать Ctrl/Cmd для выбора нескольких.</span></div></div>
