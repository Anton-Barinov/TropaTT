...
final class ClientProfileExpansionMigration implements MigrationInterface
{
    ...
    {
        return '20260422_000010_client_profile_expansion';
    }

    public function description(): string
    {
        return 'Expand clients schema with legal/person/bank/profile fields';
    }
    ...
    public function up(PDO $pdo, string $driver): void
    {
        ...
        $columns = [
            ...
            'address_legal' => $textDefinition,
            'address_postal' => $textDefinition,
            'notes' => $textDefinition,
            'extra_attributes' => $textDefinition,
        ];

        foreach ($columns as $column => $definition) {
            $this->ensureColumn($pdo, $driver, 'clients', $column, $definition);
        }
