...
final class MenuController extends BaseController
{
    private const MENU_ITEMS = [
        ...
        ['key' => 'cycles', 'i18n' => 'nav.cycles', 'label_key' => 'nav.cycles', 'href' => 'index.php?route=cycles', 'permissions' => ['cycle.view']],
        ...
        ['key' => 'docs', 'i18n' => 'nav.api', 'label_key' => 'nav.docs', 'href' => 'index.php?route=docs', 'permissions' => []],
    ];
