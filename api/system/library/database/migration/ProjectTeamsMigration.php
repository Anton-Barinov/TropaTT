...
final class ProjectTeamsMigration implements MigrationInterface
{
    public function key(): string
    {
        return '20260423_000010_project_teams';
    }

    public function description(): string
    {
        return 'Add team_public_id column to projects for team ownership and access';
    }

    public function up(PDO $pdo, string $driver): void
    {
        $columnDefinition = $driver === 'sqlsrv' ? 'NVARCHAR(64) NULL' : 'VARCHAR(64) NULL';
        $this->ensureColumn($pdo, $driver, 'projects', 'team_public_id', $columnDefinition);
    }
    ...
    private function columnExists(PDO $pdo, string $driver, string $table, string $column): bool
    {
        try {
            ...
            error_log('[ProjectTeamsMigration::columnExists] ' . $e->getMessage());
            return false;
        }
    }
