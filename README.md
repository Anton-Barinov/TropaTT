...
| MCP reference | [`docs_mcp/mcp_en.md`](docs_mcp/mcp_en.md) | Complete MCP server reference — 567 tools, resources, authentication, and RBAC (English) |
...
| MCP-справочник | [`docs_mcp/mcp_ru.md`](docs_mcp/mcp_ru.md) | Полный справочник MCP-сервера — 567 tools, ресурсы, авторизация и RBAC (на русском) |
